function getPokemonInfo() {
    ...
    fetch('https://pokeapi.co/api/v2/pokemon/' + pokemon)
        ...
        .then(data => {
            ...
            barChart(data.stats[0].base_stat,data.stats[1].base_stat,data.stats[2].base_stat,data.stats[3].base_stat,data.stats[4].base_stat,data.stats[5].base_stat);
...
function barChart(hp,atk,def,sAtk,sDef,speed){
